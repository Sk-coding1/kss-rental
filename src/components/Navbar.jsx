...
export default function Navbar() {
  ...
  const [signupPassword, setSignupPassoword] = useState('');
    ...
    <div className='bg-white py-7 px-3 border-b border-[#dfe8f3] sticky top-0 z-10'>
      <div className='flex justify-around items-center '>
          ...
          <form className="md:flex items-center max-w-lg mx-auto w-full hidden">
            <div className="relative w-full">
              <div className="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-4 h-4 text-gray-500 dark:text-gray-400">
              ...
              <button type="button" onClick={toggleSidebar} className="absolute inset-y-0 end-0 flex items-center pe-3">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-4 h-4 text-gray-500 hover:text-gray-900 ">
        ...
        <div className='flex gap-5 items-center'>
          <a href="" className=''><i className="fa fa-heart text-[#596780] border border-gray-200 rounded-full p-2 hover:bg-gray-500 hover:text-white"></i></a>
          <button onClick={toggleModal} className='bg-blue-500 text-white px-8 py-2 rounded-full text-sm font-semibold hover:bg-blue-600'>Login</button>
        </div>
      </div>
      <form className="flex items-center max-w-lg mx-auto mt-5 w-[90%] gap-3 md:hidden">
        <div className="relative w-full">
          ...
          <input type="text" id="voice-search" className="border border-gray-30 text-sm rounded block w-full ps-10 p-2.5 py-2" placeholder="Search Vehicles" required />
        </div>
        <button type="button" className="flex items-center border border-gray-30 p-2.5 py-2 rounded">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-5 h-5 text-gray-500 hover:text-gray-900 ">
            <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 6h9.75M10.5 6a1.5 1.5 0 1 1-3 0m3 0a1.5 1.5 0 1 0-3 0M3.75 6H7.5m3 12h9.75m-9.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-3.75 0H7.5m9-6h3.75m-3.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-9.75 0h9.75" />
          </svg>
        </button>
      </form>
...
<input
                    ...
                    onChange={(e) => setSignupPassoword(e.target.value)}
                    required />
