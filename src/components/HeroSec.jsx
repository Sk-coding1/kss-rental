            ...
            <div className=' flex justify-between mt-9 gap-[50px] lg:h-[350px] h-[300px] '>
                <div className='rounded-lg h-full md:w-1/2 w-full left-ad border p-5 flex flex-col justify-between'>
                    <div className='text-white w-full lg:w-2/3 flex flex-col gap-3'>
                        ...
                        <a href="" className='bg-[#3563E9] hover:bg-blue-700 px-4 py-2 rounded w-fit text-sm lg:text-[16px]'>Rental Car</a>
                    </div>
                    <div className='w-full mx-auto'>
                        <img src="../public/assets/vehicles/car/car1.png" alt="" className='w-full lg:w-[80%] mx-auto' />
                ...
                <div className='rounded-lg h-full w-1/2 right-ad border p-5 hidden md:block flex flex-col justify-between'>
                    <div className='text-white w-full lg:w-2/3 flex flex-col gap-3'>
                        ...
                        <a href="" className='bg-[#54A6FF] hover:bg-blue-400 px-4 py-2 rounded w-fit text-sm lg:text-[16px]'>Rental Car</a>
                    </div>
                    <div className='w-full mx-auto mt-5 lg:mt-0'>
                        <img src="../public/assets/vehicles/car/car2.png" alt="" className='w-full lg:w-[65%] mx-auto' />
